...
<h3>Filtra alloggi</h3>
<p>Utilizza questa form per trovare l'alloggio che fa per te</p>

<div class="container-contact1">
    <div class="wrap-contact">
        {{ Form::open(array('route' => 'catalogo', 'id' => 'addproduct', 'files' => true, 'class' => 'contact-form')) }}
